 ...
 * interrupts the current stream and starts `depsToStream(deps)` anew. So the lifetime of the
 * stream is owned entirely by the Model: to cancel it, change the Model. Return `Stream.empty`
